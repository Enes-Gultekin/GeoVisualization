...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3349',
            extent: [-20037508.342789, -20037508.342789, 20037508.342789, 20757072.970905],
            units: 'm'})
    })
});


map.getView().fit([-8056751.165968, -9526733.009856, 22551941.561435, 12936934.703645], map.getSize());
