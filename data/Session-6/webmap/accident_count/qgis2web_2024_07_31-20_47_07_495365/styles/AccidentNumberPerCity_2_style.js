...
var style_AccidentNumberPerCity_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Accidents");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Accidents") !== null) {
        labelText = String(feature.get("Accidents"));
    }
    if (value >= 8.000000 && value <= 27.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 27.000000 && value <= 38.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 38.000000 && value <= 57.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 57.000000 && value <= 97.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 97.000000 && value <= 989.000000) {
            style = [ new ol.style.Style({
